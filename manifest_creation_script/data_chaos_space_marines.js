  ...
  "datasheets": [
    ...
    },
    {
      ...
      "wargear": [
        ...
        "This model’s exalted weapon can be replaced with 1 chainfist.",
    ...
    },
    {
      ...
      "wargear": [
        ...
        "For every 5 models in this unit, up to 2 models can each have their bolt pistol replaced with 1 combi-weapon.",
        ...
        "other": [
          {
            ...
            "description": "Once per turn, at the start of your opponent’s Shooting phase, select one enemy Vehicle unit within 12\" of and visible to one or more models from your"
          },
          {
            "name": "army with this ability. That unit must take a Leadership test",
            "description": " if that test is passed, until the end of the phase, each time a model in that unit makes an attack, subtract 1 from the Hit roll; if that test is failed, that unit is not eligible to shoot this phase."
          },
          {
            "name": "Spirit Thief",
      ...
      "abilities": {
        ...
        "other": [
          ...
          },
          {
            ...
            "description": "Each time this model is selected to shoot or fight, after resolving its attacks, select one enemy unit hit by one or more of those attacks that had the"
          },
          {
            "name": "[PSYCHIC] ability. That unit must take a Leadership test",
            "description": "if that test is failed, that unit suffers D3 mortal wounds."
          }
        ],
        "special": [],
        "damaged": {
