      ...
      "abilities": {
        ...
        "other": [
          ...
          },
          {
            ...
            "description": "While an enemy unit is within 6\" of this unit, if this unit contains one or more Blue Horror models, subtract 1 from that enemy unit’s Leadership characteristic."
          },
          {
      ...
      "abilities": {
        ...
        "other": [
          ...
          },
          {
            ...
            "description": "In your Shooting phase, select"
          },
          {
            "name": "one of the following abilities",
            "description": "[IGNORES COVER]; [LETHAL HITS]; [SUSTAINED HITS D3]. Until the end of the phase, this model’s Bolt of Change has that ability."
          }
        ],
        "special": [],
        "damaged": {
        ...
        "other": [
          {
            ...
            "description": "Each time an enemy unit wishes to select this model as the target of an attack, that unit must first take a Battle-shock test. If that test if failed, in addition to being Battle-shocked, that enemy unit cannot target this model this phase."
          },
          {
